const Product = require('../MarketplaceModel/ProductModel');
...
const deleteProduct = async (req, res) => {
    try {
      ...
      await Product.deleteOne({ _id: req.params.id }); // Modern deletion method
      ...
      res.status(500).json({
        ...
        error: error.message // Now includes the specific error
      });
    }
  };
